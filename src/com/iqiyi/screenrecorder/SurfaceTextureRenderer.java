 ...
 */
public abstract class SurfaceTextureRenderer implements Runnable {
...
//	protected int height;
	 ...
	 */
	public SurfaceTextureRenderer(SurfaceTexture texture, int width, int height) {
...
//		this.height = height;
	...
	private int[] getConfig() {
		return new int[] { EGL10.EGL_RENDERABLE_TYPE, EGL_OPENGL_ES2_BIT, EGL10.EGL_RED_SIZE, 8, EGL10.EGL_GREEN_SIZE,
				8, EGL10.EGL_BLUE_SIZE, 8, EGL10.EGL_ALPHA_SIZE, 8, EGL10.EGL_DEPTH_SIZE, 0, EGL10.EGL_STENCIL_SIZE, 0,
				EGL10.EGL_NONE };
	}
